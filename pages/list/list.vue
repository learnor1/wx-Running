				...
				<view class="list-item" v-for="(i,index) in feedIndentList" :key="index">
					...
					>
					  ...
					  <view slot="footer" class="comfrim-btn">
					    <van-button type="primary" :disabled='i.user_id==store.userId' @click='receiveOrder(i.cart_id,i.user_id)'>接单</van-button>
					  </view>
					</van-card>
				</view>
		  ...
		  <van-tab title="其他订单">
			  <view class="list-content">
			  	<view class="list-item" v-for="(i,index) in otherIndentList" :key="index">
					  ...
					  <view slot="footer" class="comfrim-btn">
					    <van-button type="primary" :disabled='i.userId==store.userId' @click.prevent='orderRequest(i.id,i.userId)'>接单</van-button>
					  </view>
			  		</van-card>
			  	</view>
			  	<view class="loading" v-show="loadShow">
