      ...
      if (address_value.value.length > 0) {
        await request_index.request({
          ...
          if (value.data.code === 0) {
            common_vendor.index.removeStorageSync(obj.value.schoolId.toString());
            common_vendor.index.removeStorageSync(obj.value.storeName);
            setTimeout(() => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/frontendcode/project/Running_campus/subpages/pay/pay.vue"]]);
