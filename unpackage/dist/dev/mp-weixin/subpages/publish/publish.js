...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    let check = false;
    const checkFrom1 = (num2) => {
      let fromKeys = Object.keys(from1.value);
      check = true;
      rules[num2 - 1].forEach((i) => {
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/frontendcode/project/Running_campus/subpages/publish/publish.vue"]]);
