...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    common_vendor.onLoad(async (option) => {
      ...
      await request_index.request({
        ...
        common_vendor.index.connectSocket({
          ...
          // url:`ws://192.168.10.123:8121/api/websocket/${id}`,
          complete: () => {
          }
        });
    ...
    const sendSocketMessage = (message) => {
      console.log(message);
      common_vendor.index.sendSocketMessage({ data: message });
    };
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/frontendcode/project/Running_campus/subpages/conversation/conversation.vue"]]);
