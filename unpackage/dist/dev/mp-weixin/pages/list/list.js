      ...
      await request_index.request({
        ...
        if (res.data.code == 0) {
          ...
          common_vendor.index.connectSocket({
            url: `ws://39.99.231.129:8121/api/websocket/${id2}`,
            complete: () => {
            }
          });
      ...
      return {
        a: common_vendor.f(feedIndentList.value, (i, index2, i0) => {
          return {
            ...
            e: "582b3a8f-3-" + i0 + "," + ("582b3a8f-2-" + i0),
            f: common_vendor.p({
              type: "primary",
              disabled: i.user_id == common_vendor.unref(store).userId
            }),
            g: "582b3a8f-2-" + i0 + ",582b3a8f-1",
            h: common_vendor.p({
              price: i.money,
        ...
        e: common_vendor.f(otherIndentList.value, (i, index2, i0) => {
          return {
            ...
            d: "582b3a8f-7-" + i0 + "," + ("582b3a8f-6-" + i0),
            e: common_vendor.p({
              type: "primary",
              disabled: i.userId == common_vendor.unref(store).userId
            }),
            f: "582b3a8f-6-" + i0 + ",582b3a8f-5",
            g: common_vendor.p({
...
const MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "D:/frontendcode/project/Running_campus/pages/list/list.vue"]]);
